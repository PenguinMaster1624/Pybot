...
class Splat2nRandomWeapon(commands.Cog):
  ...
  async def rsw(self, interaction: discord.Interaction, weapon_class: str = None):
    ...
    try:
      ...
      await interaction.response.send_message(content = 'That is not a valid weapon class', ephemeral = True)
  ...
  async def rsp(self, interaction: discord.Interaction, special: str):
    ...
    try:
      ...
      await interaction.response.send_message('Not a valid special', ephemeral = True)
