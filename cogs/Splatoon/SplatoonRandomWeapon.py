...
class Splat2nRandomWeapon(commands.Cog):
  def __init__(self, bot: commands.Bot):
    ...
    self.shooter = ['Splattershot Jr.', 'Splattershot', 'Splattershot Nova', 'Splattershot Pro', 'Aerospray', 'N-ZAP', '.52 Gal', '.96 Gal' 'Jet Squelcher', 'L-3 Nozzlenose', ' H-3 Nozzlenose','Sploosh-O-Matic', 'Splash-O-Matic']
    ...
    self.blaster = ['Blaster', 'Range Blaster', 'Luna Blaster', 'Rapid Blaster Pro', 'Clash Blaster', 'S-Blast \'92']
    self.brush = ['Inkbrush', 'Octobrush', 'Painbrush']
    self.bow = ['Tri Stringer', 'REEF-LUX 450']
    self.splatana = ['Splatana Wiper', 'Splatana Stamper. Splatana Wiper Deco']
    ...
    self.sprinkler = ['Aerospray RG', '.96 Gal', 'Dynamo Roller', 'Snipewriter 5H', 'Bloblobber', 'Heavy Splatling', 'Splat Brella', 'S-Blast \'92', 'Light Tetra Dualies']
    self.splash_wall = ['.52 Gal', 'Squeezer', 'Big Swig Roller', 'Glooga Dualies', '.96 Gal Deco', 'Z+F Splat Charger', 'Z+F Splatterscope', 'H-3 Nozzlenose D']
    ...
    self.squid_beakon = ['Dapple Dualies', 'Tenta Brella', 'Neo Sploosh-o-matic', 'Krak-On Splat Roller', 'Splatana Wiper Deco']
    self.point_sensor = ['Splattershot Nova', 'H-3 Nozzlenose', 'Classic Squiffer', 'Explosher', 'Nautilus 47']
    self.ink_mine = ['Rapid Blaster', 'Flingza Roller', 'Inkbrush Nouveau', 'E-Liter 4K', 'E-Liter 4K Scope', 'Undercover Brella', 'Annaki Splattershot Nova', 'Tenta Sorella Brella']
    self.toxic_mist = ['Rapid Blaster Pro', 'Tri-Slosher', 'Zink Mini Splatling', 'Tri-Stringer', 'Custom Jet Squelcher']
    self.angle_shooter = ['Splattershot Pro', 'Jet Squelcher', 'Slosher Deco', 'Big Swig Roller Express', 'Rapid Blaster Pro Deco']
    ...
    self.tenta_missiles = ['Flingza Roller', 'Goo Tuber', 'REEF-LUX 450', 'Splatana Wiper Deco']
    self.ink_storm = ['Bloblobber', 'Explosher', 'Nautilus 47', 'Custom Jet Squelcher', 'Big Swig Roller Express']
    ...
    self.inkjet = ['Tri-Slosher', 'Ballpoint Splatling', 'Rapid Blaster Deco', 'Annaki Splattershot Nova']
    ...
    self.reefslider = ['Aerospray MG', 'Dapple Dualies Nouveau', 'Dark Tetra Dualies', 'Undercover Brella', 'S-Blast \'92']
